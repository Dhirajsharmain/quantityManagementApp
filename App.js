    ...
    <SafeAreaView style= {{flex:1, backgroundColor: '#F5F6FA'}}>
      ...
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Home">
            <Stack.Screen name="Home" component={LengthMeasurement} options={{ headerShown: false }}/>
            <Stack.Screen name="Temperature" component={TempMeasurement} options={{ headerShown: false }}/>
            <Stack.Screen name="Volume" component={VolumeMeasurement} options={{ headerShown: false }}/>
        </Stack.Navigator>
      </NavigationContainer>
    </SafeAreaView>
